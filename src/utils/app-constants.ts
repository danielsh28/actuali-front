export const DEFAULT_SRC_IMG: string =
...
export const ACTUALI_SERVER_BASE_URL_DEV = "http://localhost:4000";
export const ACTUALI_SERVER_BASE_URL = "https://actuali-back.herokuapp.com";
